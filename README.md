...
Section:NewButton("Teleport1", "Teleport to blue trash", function()
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-183.7913360595703, -32.648170471191406, 1610.7633056640625)
end)
Section:NewButton("Teleport2", "Teleport to cafe", function()
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-200.91847229003906, -19.243457794189453, 1475.7001953125)
end)
Section:NewButton("Teleport3", "Teleport to Summon show", function()
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-636.7684936523438, -31.89116096496582, 1205.2376708984375)
end)
Section:NewButton("Teleport4", "Teleport to Tree", function()
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-696.6896362304688, -31.68730354309082, 1416.8941650390625)
end)
Section:NewButton("Teleport5", "Teleport to Library", function()
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-40.15901565551758, -116.26957702636719, 363.89556884765625)
end)
Section:NewButton("Teleport6", "idk", function()
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-505.4895935058594, -32.49283981323242, 1832.2938232421875)
end)
Section:NewButton("Teleport7", "Office", function()
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-234.5438995361328, -30.83466148376465, 1576.4620361328125)
end)
-- end event
